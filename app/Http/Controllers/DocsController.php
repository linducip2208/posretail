        ...
        return [
            ...
            [
                ...
                'steps' => [
                    ...
                    'Tambah <strong>Unit/Satuan</strong> — Pcs, Box, Kardus, Kg, Liter.',
                    'Tambah <strong>Produk</strong> — lengkapi SKU, barcode, harga beli, harga jual, harga grosir, harga member, stok minimum & maksimum.',
                    'Tambah <strong>Varian Produk</strong> jika produk memiliki pilihan (warna, ukuran, rasa) — stok per varian.',
            ...
            [
                ...
                'steps' => [
                    ...
                    'Gunakan <strong>POS Web</strong> di <code>/pos</code> — antarmuka kasir cepat via browser.',
                    'Scan barcode dengan <strong>USB Scanner</strong> (auto-detect) atau <strong>Kamera HP</strong>.',
        ...
        return [
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Produk & Varian',
                        'desc' => 'Kelola ribuan produk dengan SKU, barcode, dan varian. Dukung multi-harga: eceran, grosir, dan member.',
                        'bullets' => [
                            'SKU dan barcode unik per produk',
            ...
            [
                ...
                'items' => [
                    [
                        'title' => 'Point of Sale',
                        'desc' => 'Antarmuka kasir yang cepat dan intuitif. Scan barcode, pilih produk, hitung otomatis — transaksi selesai dalam hitungan detik.',
                        'bullets' => [
                            'Scan barcode untuk tambah item instan',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'desc' => 'Konfigurasi global: pajak, mata uang, approval threshold, format nota. Sesuaikan sistem dengan kebutuhan bisnis Anda.',
                        'bullets' => [
                            'Pajak default (PPN)',
                            'Mata uang',
